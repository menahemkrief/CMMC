...
void bind_compton_matrix_mc(pybind11::module& m) {
    ...
    pybind11::class_<ComptonMatrixMC>(m, "ComptonMatrixMC")
        ...
        .def("get_tau_matrix",  pybind11::overload_cast<double const, double const, double const, double const>(&ComptonMatrixMC::get_tau_matrix, pybind11::const_), pybind11::kw_only(), "temperature"_a, "density"_a, "A"_a, "Z"_a)
        .def("get_dtau_matrix", pybind11::overload_cast<double const, double const, double const, double const>(&ComptonMatrixMC::get_dtau_matrix, pybind11::const_), pybind11::kw_only(), "temperature"_a, "density"_a, "A"_a, "Z"_a)
        ;
}
